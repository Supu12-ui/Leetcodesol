...
<p><span style="font-size:18px">The dimensions of the matrices are given in an array <strong>arr[]</strong>&nbsp;of&nbsp;size&nbsp;<strong>N</strong> (such that N = number of matrices + 1) where the <strong>i<sup style="">th</sup></strong> matrix has the dimensions&nbsp;<strong>(arr[i-1]&nbsp;x arr[i])</strong>.</span></p>
...
<p><br>
<span style="font-size:18px"><strong>Expected Time Complexity:</strong> O(N<sup style="">3</sup>)<br>
<strong>Expected Auxiliary Space:</strong> O(N<sup style="">2</sup>)</span></p>
